...
Each georeferenced location is assigned a unique locationID (http://rs.tdwg.org/dwc/terms/locationID) and can be used to share georeferences among GeoPick users. GeoPick provides with a share link in the form of _ht&#8203;tps\://geopick.gbif.org/?locationid=<locationID\>_. 
