...
Each georeferenced location is assigned a unique locationID (http://rs.tdwg.org/dwc/terms/locationID) and can be used to share georeferences among GeoPick users. GeoPick provides with a share link in the form of _https\://geopick.gbif.org/?locationid=<locationID\>&#8203;_. 
